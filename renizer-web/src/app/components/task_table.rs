                    ...
                    <div class="block w-full overflow-x-auto">
                        <table class="text-blueGray-700 w-full border-collapse items-center">
                            <thead class="thead-light">
                                <tr>
                                    <th class="bg-blueGray-50 text-blueGray-500 border-blueGray-100 whitespace-nowrap border border-l-0 border-r-0 border-solid px-6 py-3 text-center align-middle text-xs font-semibold uppercase">
                                        Task
                                    </th>
                                    <th class="bg-blueGray-50 text-blueGray-500 border-blueGray-100 whitespace-nowrap border border-l-0 border-r-0 border-solid px-6 py-3 text-center align-middle text-xs font-semibold uppercase">
                                        Assigned at
                                    </th>
                                    <th class="bg-blueGray-50 text-blueGray-700 border-blueGray-100 min-w-140-px whitespace-nowrap border border-l-0 border-r-0 border-solid px-6 py-3 text-center align-middle text-xs font-semibold uppercase">
                                        Strat Date
                                    </th>
                                    <th class="bg-blueGray-50 text-blueGray-700 border-blueGray-100 min-w-140-px whitespace-nowrap border border-l-0 border-r-0 border-solid px-6 py-3 text-center align-middle text-xs font-semibold uppercase">
                                        Delivery Date
                            ...
                            <tbody>
                                <For
                                    each=tasks
                                    key=|(id, _)| id.clone()
                                    children=move |(_, task)| {
                                        view! {
                                            <tr>
                                                <th class="whitespace-nowrap border-l-0 border-r-0 border-t-0 p-4 px-6 text-center align-middle text-xs">
                                                    {task.task_name}
                                                </th>
                                                <td class="whitespace-nowrap border-l-0 border-r-0 border-t-0 p-4 px-6 text-center align-middle text-xs">
                                                    {task.assigned_date.to_string()}
                                                </td>
                                                <td class="whitespace-nowrap border-l-0 border-r-0 border-t-0 p-4 px-6 text-center align-middle text-xs">
                                                    {task.start_date.to_string()}
                                                </td>
                                                <td class="whitespace-nowrap border-l-0 border-r-0 border-t-0 p-4 px-6 text-center align-middle text-xs">
                                                    {task.delivery_date.unwrap_or_default().to_string()}
                                                </td>
                                                <td class="whitespace-nowrap border-l-0 border-r-0 border-t-0 p-4 px-6 text-center align-middle text-xs">
                                                    {task.hour_taken.unwrap_or_default().to_string()}
                                                </td>
                                            </tr>
                                        }
                                    }
